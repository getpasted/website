...
export default function App({ storyContent }: { storyContent?: ReactNode }) {
  const story = storyContent !== undefined;
  ...
  useScrollReveal(
    ".release-copy,.covenant-intro>div:first-child",
    ".release-section>div:last-child,.covenant-intro>div:last-child",
    ".covenant-grid,.covenant-endorsement,.feedback-copy,.feedback-terminal,.final-cta>img,.final-cta>h2,.final-cta>p,.final-cta>.button",
  );
  ...
  return (
    <div className="site-shell" onCopy={() => {
      ...
      <header className="site-header">
        <a className="brand" href={story ? "/" : "#top"} aria-label="Pasted home"><span className="brand-mark"><img src="/pasted-mark.svg" alt="" /></span>Pasted</a>
        <a className="header-download" href={story ? "/#download" : "#download"}>Download <span>↓</span></a>
      </header>
